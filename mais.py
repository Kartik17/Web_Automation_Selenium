...
driver.get('http://10.21.6.100:9090/mais/index.action') #Open mais page
...
user_name.send_keys('IS05353')#Change USER ID
#user_name.send_keys('05')
#user_name.send_keys('3')
#user_name.send_keys('53')
driver.implicitly_wait(30)

password= driver.find_element_by_name('password')#Find the password tag element
password.clear()
password.send_keys('9452737104Ad')#Change USER PASSWORD
driver.implicitly_wait(30)
...
driver.find_element_by_xpath("//select[@name='project']/option[text()='CHANDRAYAAN-2']").click()#Change PROJECT
...
driver.find_element_by_xpath("//select[@name='aauthority']/option[text()='SHANKARA A']").click()#Change APPROVING AUTHORITY
...
#writer = ExcelWriter('mais_new.xlsx')
#df.to_excel(writer,'Sheet1')
#writer.save()
	
#df.hist()	
#plt.hist(bins = np.unique(df['Raw Material']))
#plt.show()
#size1,2,3
#id='matquantity'
#purchaseOrder
